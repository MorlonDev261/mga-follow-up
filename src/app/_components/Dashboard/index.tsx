            ...
            <div className="bg-[#111] p-2">
              <div className="mb-4">
                ...
                <div className="my-2 flex items-center justify-between text-2xl font-bold">
                  ...
                  >
                    <DropdownMenuItem> 
                      <DialogPopup className="w-full" label={<button><AiOutlineProduct /> New arrivals</button>} title="Insertion new arrivals"  desc="Fill in the details to add a new product.">
                    ...
                    <DropdownMenuItem>
                      <DialogPopup className="w-full" label={<button><FaClipboardUser />&nbsp;New employer</button>} title="Insertion new arrivals"  desc="Fill in the details to add a new product.">
                        {(setOpen) => <UserForm type="customer" status="post" setOpen={setOpen} />}
                      </DialogPopup>
                    </DropdownMenuItem>
                  </Dropdown>
