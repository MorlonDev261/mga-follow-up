...
const shortcuts = [
  {
    ...
    value: 457900,
    icon: <BsShopWindow />,
    color: "from-blue-500 to-blue-700 text-blue-600 dark:text-white dark:from-blue-800 dark:to-blue-900",
  },
  {
    label: "Expenses",
    to: "/expenses",
    value: 457900,
    icon: <FiDollarSign />,
    color: "from-orange-500 to-orange-700 text-orange-600 dark:text-white dark:from-orange-800 dark:to-orange-900",
  },
  {
    label: "Pending",
    to: "/pending",
    value: 457900,
    icon: <FiClock />,
    color: "from-yellow-600 to-yellow-800 text-yellow-700 dark:text-white dark:from-yellow-700 dark:to-yellow-900",
  },
  { label: "Employers", to: "/employers", value: 7, icon: <BsPersonWorkspace />, color: "bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-300" },
  { label: "Transactions", to: "/transactions", icon: <SwapWallet />, color: "bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-300" },
  { label: "Customers", to: "/customers", value: 7, icon: <FaUsers />, color: "bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-300" },
];
