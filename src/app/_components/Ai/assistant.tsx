  ...
  return (
    <>
      ...
      <motion.div
        ...
        initial={{ opacity: 0, scale: 0.95, width: '100%', height: '100%' }} // Valeurs initiales (disparu et réduit)
        animate={{ 
          opacity: isChatOpen ? 1 : 0, 
          scale: isChatOpen ? 1 : 0.95, 
          width: isChatOpen ? '100%' : '0%', // Réduit la largeur quand isChatOpen est false
          height: isChatOpen ? '100%' : '0%', // Réduit la hauteur quand isChatOpen est false
        }}
        exit={{ opacity: 0, scale: 0.95, width: '0%', height: '0%' }} // Réduit également en exit
