...
export default function Chat() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div 
        className={`fixed bottom-24 mx-2 sm:right-6 w-96 h-4/5 max-h-[600px] bg-gray-50 rounded-xl shadow-2xl overflow-hidden flex flex-col transition-all duration-300 transform ${
